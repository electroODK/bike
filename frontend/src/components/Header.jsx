...
const Header = () => {
  ...
  return (
    <>
          ...
          <nav className={styles.navbar}>
            <div className={styles.navLeft}>
              <Link to="/" className={styles.logo}>
                <img src={logoImage} alt="BikePark Logo" />
              </Link>
              <div className={styles.navLinks}>
                <Link to="/about" className={styles.hideOnTablet}>
                  О нас
                </Link>
                <Link to="/Rent" className={styles.mainLink}>
                  Аренда
                </Link>
                <Link to="/delivery" className={styles.mainLink}>
                  Доставка
                </Link>
                <Link to="/places" className={styles.hideOnTablet}>
                  Где кататься
                </Link>
                <Link to="/contacts" className={styles.hideOnTablet}>
                  Контакты
                </Link>
              </div>
            </div>
            <div className={styles.navRight}>
              <a href="tel:+971525634064" className={styles.phoneNumber}>
                +971 52 563 4064
              </a>
              <div className={styles.profileContainer} ref={avatarRef}>
                ...
                >
                  <img
                    src={isAvatarDropdownOpen ? notFoundImage : profileImage}
                    alt="Profile Icon"
                  />
                </button>
                ...
                {isAvatarDropdownOpen && (
                  <div className={styles.avatarDropdown}>
                    {/* Если админ → показываем "Админ-панель", иначе "Личный кабинет" */}
                    {isAdmin ? (
              ...
              <div className={styles.timeContainer} ref={timeRef}>
                ...
                >
                  ...
                  <span className={styles.currentCity}>
                    Time in {selectedTimezone.name}
                  </span>
                </div>
                {isTimeDropdownOpen && (
        ...
        <div className={styles.tabletDropdownMenu}>
          <div className={styles.dropdownMenuContent}>
            <div className={styles.dropdownLinks}>
              <Link to="/rentals" onClick={closeAllMenus}>
                Аренда
              </Link>
              <Link to="/delivery" onClick={closeAllMenus}>
                Доставка
              </Link>
              <Link to="/about" onClick={closeAllMenus}>
                О нас
              </Link>
              <Link to="/places" onClick={closeAllMenus}>
                Где кататься
              </Link>
      ...
      {isMobileMenuOpen && (
        <div className={styles.backdrop} onClick={closeAllMenus}></div>
      )}
          ...
          <div className={styles.mobileMenuFooter}>
            {isLoggedIn ? (
              <>
                <Link
                  to="/profile"
                  className={styles.mobileCabinetLink}
                  onClick={closeAllMenus}
                >
                  Личный кабинет
                </Link>
